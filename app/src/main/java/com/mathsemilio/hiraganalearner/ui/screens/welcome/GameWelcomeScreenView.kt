...
abstract class GameWelcomeScreenView :
    BaseObservableView<GameWelcomeScreenBinding, GameWelcomeScreenView.Listener>() {

    interface Listener {
        fun onSettingsIconClicked()

        fun onDifficultyOptionSelected(difficulty: String)
    ...
    abstract fun bindDifficultyValues(defaultDifficultyValue: String, difficultyValue: Int)
}