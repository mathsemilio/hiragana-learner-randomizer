...
abstract class GameResultScreenView :
    BaseObservableView<GameResultScreenBinding, GameResultScreenView.Listener>() {
    ...
    abstract fun bindGameResult(score: Int, difficultyValue: Int, perfectScores: Int)
